Unit 4 Lab 4: Data Representation and Compression, Page 3</title>
	</head>

	<body>
		<h2>Representing Whole Numberssubtitle: "Unit , Lab , Page"
order:
---
        <div class="todo">
        ...
        <div class="forYouToDo" id="first">
			<ol>
				<li>
					...
					<div class="sidenote">If you look at the code, you'll see that it's a recursive reporter. How does it work? You first saw recursion on <a href="/cur/programming/3-lists/1-abstraction/2-fractal-art.html?topic=nyc_bjc%2F2-conditionals-abstraction.topic&course=bjc4nyc.html&novideo&noassignment" title="Unit 3 Lab 1 Page 2: Fractal Art">Unit 3 Lab 1 Page 2: Fractal Art</a>.</div> <strong></strong>
                    ...
                    <a class="run" href="/prog/4-internet/U4L4-BigNumbers.xml" target="_blank"><img class="inline" src="/img/icons/load-save.png" alt="Click here to load this file. Then save it to your Snap! account." title="Click here to load this file. Then save it to your Snap! account."></a> Try out these inputs:<br />
			    	<div class="sidenote">You might see different results depending on your computer's processor.</div>
					<ol>
                        <li><img src="/img/4-internet/bang5.png" alt="(5)! reporting 120" title="(5)! reporting 120" /></li>
                        <li><img src="/img/4-internet/bang10.png" alt="(10)! reporting 3628800"  title="(10)! reporting 3628800" /></li>
                        <li><img src="/img/4-internet/bang20.png" alt="(20)! reporting 2432902008176640000" title="(20)! reporting 2432902008176640000" /></li>
                        <li><img src="/img/4-internet/bang30.png" alt="(30)! reporting 2.6525285981219103e+32" title="(30)! reporting 2.6525285981219103e+32" /></li>
		...
		<h2>Fixed Width Computer Hardware</h2>
        <div class="vocabBig">
        ...
        <div class="comment">DAT-1.B.1</div>
        ...
        <div class="endnote">
        	<a href="#hint-power-2" data-bs-toggle="collapse" title="Are processor widths always powers of two?">Are processor widths always powers of two?</a>
		...
		<h2>Bignums</h2><div class ="sidenote"> A multiple-word integer is called a <strong>bignum</strong>. </div>
        <div class="comment">DAT-1.B.2</div>
        ...
        <div class="takeItFurther">
            <img class="imageRight" src="/img/icons/tough-stuff-mini.png" alt="Tough Stuff" title="Tough Stuff" />
            <ol type="A">
        ...
        <div class="forYouToDo">
            <ol start="3">
                <div class="sidenoteBig">You can use bignums in any Snap<em>!</em> project by importing the "Bignums, exact rationals, complex #s" library. <div class="todo"><p>You learned to import libraries on the <a href="/cur/programming/6-computers/1-abstraction/04-software-libraries.html?topic=nyc_bjc%2F6-how-computers-work.topic&course=bjc4nyc.html&novideo&noassignment" title="The Software Domain: Libraries">Libraries</a> page.</p> They did not. --MF, 6/13/19</div></div>
                <li>
                    Click on this block in the scripting area:<br />
                    <img class="indent" src="/img/4-internet/bignums-true.png" alt="USE BIGNUMS (true)" title="USE BIGNUMS (true)" /> 
                </li>
                <li>
                	Now try <code>30!</code> again.<br />
                    <img class="indent" src="/img/4-internet/bang30-bignum.png" alt="30! reporting 265252859812191058636308480000000" title="30! reporting 265252859812191058636308480000000" />
                ...
                <li>
                    ...
                    <ol type="a">
                        <li>Hold down the control key and click the <img class="inline" src="/img/4-internet/200-factorial.png" alt="() !" title="() !" /> block.</li>
