Unit 4 Lab 4: Data Representation and Compression, Page 4</title>
	</head>

	<body>
		<h2>Floating Pointsubtitle: "Unit , Lab , Page"
order:
---
        <div class="todo">
        ...
        <div class="endnote">
            <a href="#hint-float" data-bs-toggle="collapse" title="Where did that funny name come from?">Where did that funny name come from?</a>
        ...
        <div class="forYouToDo" id="first">
			<ol>
				<li>For example, try<img src="/img/4-internet/one-third.png" alt="(1)/(3)" title="(1)/(3)"> once with bignums on and once with bignums off.</li>
            </ol>
        </div>
    ...
    Al, I think you must have switched between bignums-on and bignums-off between trials. With bignums on I get correct exact rational answers for both. --bh</div>
        <div class="forYouToDo">
			<ol start="2">
				<li>
                Try <img class="inline" src="/img/4-internet/0.2+0.4.png" alt="(0.2) + (0.4)" title="(0.2) + (0.4)" /> and then try <img class="inline" src="/img/4-internet/7.6+8.7.png" alt="(7.6) + (8.7)" title="(7.6) + (8.7)" />.</li>
            </ol>
        </div>
        <p>This isn't a bug in Snap<em>!</em>, which is correctly reporting the result computed by the floating point hardware.</p>
		<div class="endnote">
        	<a href="#hint-roundoff" data-bs-toggle="collapse" title="How can such simple computations get wrong results?">How can such simple computations get wrong results?</a>
		...
		<div class="endnote">
			<a href="#hint-killer" data-bs-toggle="collapse" title="Floating point errors can be very expensive and can even kill people">Floating point errors can be very expensive and can even kill people.</a>
		...
		<div class="endnote">
            <a href="#hint-alternatives" data-bs-toggle="collapse" title="There are alternatives to floating point">There are alternatives to floating point.</a>
        ...
        <p>
        	...
        	<img class="indent" src="/img/4-internet/bang30.png" alt="(30) ! reporting 2.6525285981219103e+32" title="(30) ! reporting 2.6525285981219103e+32" />
        </p>
        ...
        <div class ="forYouToDo">
            <ol start="3">
                <li>
                    ...
                    <img src="/img/4-internet/200bang-fixnum.png" alt="((200) !) reporting infinity" title="((200) !) reporting infinity" />
                </li>
            </ol>
        </div>
        ...
        <div class="endnote">
          ...
          <img class="indent" src="/img/4-internet/zero-div-zero-reporting-NaN.png" alt="(0) / (0) reporting NaN" title="(0) / (0) reporting NaN" />
        </div>
        ...
        <div class="endnote">
            <a href="#hint-data-types" data-bs-toggle="collapse" title="But different languages use data types differently">But different languages use data types differently.</a>
            <div id="hint-data-types" class="collapse">
                <p>
                	...
                	<img class="indent" src="/img/4-internet/intfoo.png" alt="integer (foo)" title="integer (foo)"><br />
        ...
        <div class="forYouToDo">
			<ol start="4">
				<li><div class="comment">DAT-1.B</div><img class="inline" src="/img/icons/talk-with-your-partner.png" alt="Talk with Your Partner" title="Talk with Your Partner" />What are some consequences of using a fixed number of bits to represent numbers?</li>
			</ol>
		</div>
