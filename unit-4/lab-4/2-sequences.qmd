Unit 4 Lab 4: Data Representation and Compression, Page 2</title>
	</head>

	<body>
		<h2>Binary Sequencessubtitle: "Unit , Lab , Page"
order:
---
        <div class="todo">
        ...
        <div class="endnote">
            <p><a href="#hint-size-table" data-bs-toggle="collapse" title="How much information fits in a gigbyte?">How much information fits in a gigabyte?</a></p>
            <div id="hint-size-table" class="collapse">
                ...
                <p><a href="#hint-target" data-bs-toggle="collapse" title="Where do these prefixes like 'tera-' and 'peta-' come from?">Where do these prefixes like "tera-" and "peta-" come from?</a></p>
        ...
        <div class="comment">DAT-1.A.6</div>
...
<a class="run" href="/prog/4-internet/U4L4-TranslatingBinary.xml" target="_blank"><img class="inline" src="/img/icons/load-save.png" alt="Click here to load this file. Then save it to your Snap! account." title="Click here to load this file. Then save it to your Snap! account."></a>
                    <p>
                        ...
                        <ul>
                            <li>
                                ...
                                <img class="indent" src="/img/6-computers/translate-text-to-binary.png" alt="translate text () to binary sequence" title="translate text () to binary sequence" />
                            </li>
                            <li>
                            	A reporter that accepts a binary sequence as input and translates it into text:<br />
                                <img class="indent" src="/img/6-computers/translate-binary-to-text.png" alt="translate binary sequence () to text" title="translate binary sequence () to text" />
                            </li>
                            <li>
                                ...
                                <img class="indent" src="/img/6-computers/translate-binary-to-image.png" alt="translate binary sequence () to B&W image that is () pixels wide and scaled by factor of ()" title="translate binary sequence () to B&W image that is () pixels wide and scaled by factor of ()" />
                            </li>
                        </ul>
                    </p>
                </li>
				<li>
                	...
                	<ul>
                        ...
                        <li>
							...
							<img class="indent" src="/img/6-computers/set-output-to-translate-text.png" alt="set (output) to (translate text (Beauty and Joy of Computing) to binary sequence)" title="set (output) to (translate text (Beauty and Joy of Computing) to binary sequence)" />
						</li>
                        <li>
                            ...
                            <img class="indent" src="/img/6-computers/exporting-output-watcher.png" alt="image of output watcher on stage storing a binary sequence with the drop-down menu open and  'export...' option selected" title="image of output watcher on stage storing a binary sequence with the drop-down menu open and  'export...' option selected" />
                        </li>
                    </ul>
                </li>
                <div class="endnote">
                    ...
                    <img class="indent" src="/img/6-computers/binary-sequences-bug.png" alt="image of output pasted into block and extending past the edges of the block" title="image of output pasted into block and extending past the edges of the block" />
                </div>
				<li>
                ...
                <li>
                    ...
                    <img class="indent" src="/img/web/bjc-logo.png" alt="Beauty and Joy of Computing logo: a 'b,' a 'j,' and a 'c' looking like two eyes and a nose with a smile below" title="Beauty and Joy of Computing logo: a 'b,' a 'j,' and a 'c' looking like two eyes and a nose with a smile below" /> 
                </li>
                <div class="comment">DAT-1.A</div>
        ...
        <div class="comment">DAT-1.A.8, DAT-1.A.9, DAT-1.A.10</div>
        <div class="vocabBig">
        ...
        <div class="endnote">
            <a href="#hint-analog" data-bs-toggle="collapse" title="More examples, please.">More examples, please.</a>
        ...
        <div class="takeNote" style="clear: right;">
            ...
            <div class="comment">DAT-1.A.7</div>
        ...
        <div class="comment">AAP-1.A.3 first sentence</div>
        <p>
            ...
            <img class="indent" src="/img/4-internet/varfoo.png" alt="script variables (foo)" title="script variables (foo)" /><br />
            you see things like<br />
            <img class="indent" src="/img/4-internet/intfoo.png" alt="integer (foo)" title="integer (foo)" />
        </p>
