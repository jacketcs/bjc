Unit 4 Lab 4: Data Representation and Compression, Page 6</title>
	</head>

	<body>
		<h2>Data Compressionsubtitle: "Unit , Lab , Page"
order:
---
        ...
        <img class="imageRight" src="/img/6-computers/bjc-logo-original.png" alt="BJC logo uncompressed" title="BJC logo uncompressed" />
        ...
        <p class="indent">...<img src="/img/6-computers/top-row-of-pixels-in-bjc-logo.png" alt="top-row-of-pixels-in-bjc-logo: 4 white, 6 yellow-orange, 3 white" title="top-row-of-pixels-in-bjc-logo: 4 white, 6 yellow-orange, 3 white">...</p>
        ...
        <p>
            ...
            <img class="indent" src="/img/6-computers/pond.bmp" alt="pond pebbles" title="pond pebbles" />
            <img src="/img/6-computers/pond.jpg" alt="pond pebbles" title="pond pebbles" />
        </p>
        ...
        <div class="endnote">
            <p><a href="#hint-sizes" data-bs-toggle="collapse" title="What size is this file when encoded in different formats?">What size is this file when encoded in different formats?</a></p>
