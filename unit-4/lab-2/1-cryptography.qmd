...
::: todo
<p>BH: It would be nice to look at some serious ciphers, e.g.,
Playfair.</p>
:::

::: learn
<p><strong>In this lab,</strong> you will learn about security risks on
the Internet and how data can be encoded to protect it.</p>

<p><strong>On this page,</strong> you will experiment with different
...
<li><strong>Encryption</strong> is the process of encoding data to
prevent unauthorized access.</li>

<li><strong>Decryption</strong> is the process of decoding the
data.</li>
...
::: {.indent .fixedwidth}
PQVFUBZOTHWYELIXRNAMGDSCKJ<img src="/img/4-internet/this-is-the-key.jpg" title="This is the key." alt="This is the key." class="noshadow nopad"/>
:::
...
::: {.indent .fixedwidth}
DEFGHIJKLMNOPQRSTUVWXYZABC<img src="/img/4-internet/this-is-the-key.jpg" title="This is the key." alt="This is the key." class="noshadow nopad"/>
:::
...
<p>Substitution ciphers are examples of <strong>symmetric
encryption</strong> because they use the <em>same key</em> for both
encryption and decryption.</p>
:::

::: endnote
<p>There are more complicated methods of symmetric encryption, but they
always use the same key at both ends.
<a href="#hint-symmetric" data-toggle="collapse" title="How has symmetric encryption been used?">How
has symmetric encryption been used?</a></p>
