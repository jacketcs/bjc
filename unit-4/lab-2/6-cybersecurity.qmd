...
::: learn
<p><strong>On this page,</strong> you will learn ways to protect your
data and your computer.</p>
:::
...
<p>Nicola Whiting MBE, is an award winning jewelry designer and author,
...
culture, policy and practice.</p>

<p><a href="https://nicolawhiting.com/all-the-voices-at-the-table/" title="Article by Nicola Whiting: All the Voices at the Table: the Benefits of Diversity" target="_blank">Article
by Nicola Whiting: All the Voices at the Table: the Benefits of
Diversity</a></p>
:::

::: comment
design flaws: IOC-2.B.10, authentication measures: IOC-2.B.1, strong
passwords: IOC-2.B.2, multifactor authentication: IOC-2.B.3, IOC-2.B.4,
malicious link: IOC-2.C.5, IOC-2.C.6, security settings: IOC-2.B.11
:::

<li><strong>Run up-to-date software.</strong> The Windows 98 operating
...
<li><strong>Use strong passwords.</strong> You need a separate password
...
<li><strong>Enable multifactor authentication</strong> (such as
...
<li><strong>Don't click links</strong> on websites or especially in
email, <strong>without first double-checking</strong> that the actual
...
<li><strong>Don't use sketchy software. </strong>If the advertising says
...
<li><strong>Regularly review your security settings</strong> for the
websites, apps, and programs you use. You can control the permissions
for collecting and sharing your information.</li>

<li><strong>Install Antivirus and anti-malware software.</strong> There
...
<li><strong>Don't connect to insecure WiFi.</strong> Ideally, WiFi
