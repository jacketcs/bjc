...
::: todo
Brian, I added "initials part deux" as an ITIT on this page. See below.
Is it too much for an ITIT? Should it be a TIF? I can't decide. If you
like it, please add it to the solutions file and <em>only then</em> cut
this comment. If you don't, please revise it or cut it. --MF, 7/4/20
:::

::: learn
<strong>On this page,</strong> you will program a shift cipher procedure
to encrypt/decrypt text.
:::

<p>Computers store keyboard characters (capital and small letters,
...
characters:<br />
<img src="/img/4-internet/img_CaesarCipher/Mary_CharacterTable.jpeg" alt="Unicode Table" class="indent noshadow" height="330px"/></p>

<p>The <code>unicode of</code> block reports the number that is used for
a particular character:<br />
<img src="/img/4-internet/img_CaesarCipher/SnapUnicode1.png" title="unicode of (a) reporting &apos;97&apos;" alt="unicode of (a) reporting &apos;97&apos;" class="indent" height="52"/><br />
The <code>unicode as letter</code> block reports the character that a
given Unicode number represents:<br />
<img src="/img/4-internet/img_CaesarCipher/SnapUnicode2.png" title="unicode (65) as letter reporting &apos;A&apos;" alt="unicode (65) as letter reporting &apos;A&apos;" class="indent" height="52"/></p>

::: {#second .forYouToDo}
<ol>

<li>Experiment with the <code>unicode of</code> and <code>unicode as
letter</code> blocks. Try changing a word into Unicode, telling the
...
::: endnote
<p><a href="#hint-characters" data-toggle="collapse" title="Why do we see characters like = ? @ # ^ * { or ~ ?">Why
do we see characters like <strong>= ? \@ \# \^ \* { </strong> or
<strong>\~</strong> ?</a></p>

::: {#hint-characters .collapse}
<p>You can safely assume that shifting any set of text characters a
reasonable distance will result in a set of printable characters, which
may include non-alphanumeric (not letter or digit) characters.</p>

<p>For example, if we use a shift of 4 to encrypt:</p>

<p class="indent">

<em><strong>Invasion of Normandy is on 6 June 1944</strong></em>
...
<em><strong>Mrzewmsr$sj$Rsvqerh}$mw$sr$:$Nyri\$5=88</strong></em>
...
<p><a href="#hint-missing" data-toggle="collapse" title="What if your decrypted text is missing some letters?">What
if your decrypted text is missing some letters?</a></p>

::: {#hint-missing .collapse}
<p>If you copy your encrypted message with a method other than by using
...
A, you can develop a method of encryption that avoids this problem.</p>
:::
:::
...
<img src="/img/4-internet/img_CaesarCipher/Export.png" title="export option" alt="export option" class="indent" width="350"/>
:::
...
Improve your <code>initials</code> block from your U3L2-ContactList
project so that it will find the initials for a person with a hyphenated
name like Alexandria Ocasio-Cortez.<br />
<img src="/img/4-internet/initials-reporting-aoc.png" title="initials of (Alexandria Ocasio-Cortez) reporting AOC" alt="initials of (Alexandria Ocasio-Cortez) reporting AOC" class="indent"/>

::: endnote
<a href="#hint-initials" data-toggle="collapse" title="Click for some hints about improving your initials block.">Click
for some hints.</a>
...
One way is to use the <code>unicode</code> block to select all the
...
a block like <code>is between?</code> from your U2L4-MathLibrary project
...
Another way is to use the <code>split</code> block to check for hyphens
as well as to check for spaces between words.

<ul>

<li>If you want to use <code>split</code>, note that the second input to
<code>split</code> can be the character you want to use as the word
separator. (You learned about <code>split</code> on
<a href="/unit-3/lab-2/5-mapping-over-list.html" title="Unit 3 Lab 2 Page 5: Transforming Every List Item">Unit
