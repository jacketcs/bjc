...
:::::: ifTime
A. Add a "+1" button that will add one to the digits when you press it.
B. Make a version of the program that will keep track of numbers in a base other than 2 (try base 16, called 'hexidecimal', also used in computer science)
