...
::: learn
<p><strong>On this page,</strong> you will learn about the communities
of people who control how the Internet works.</p>
:::

<p>Some people think that nobody's in charge of the Internet---that
...
<strong><a href="/4-internet/old/4-address-hierarchy.html" title="Address Hierarchy">domain
name hierarchy</a></strong> was entirely controlled by the United States
...
<p>The growth of the Internet has been fueled by <strong>open
protocols</strong>, standards that are <em>not owned by a
company</em>.</p>
...
<strong>HTTP</strong>, Simple Mail Transfer Protocol
(<strong>SMTP</strong>) and secure sockets layer/transport layer
security (<strong>SSL</strong>/<strong>TLS</strong>)</li>

<li>Standards for <em>packets and routing</em> include transmission
control protocol/Internet protocol
(<strong>TCP</strong>/<strong>IP</strong>).</li>

</ul>
:::

<p>The protocols for the Internet change over time. The <strong>Internet
Engineering Task Force (IETF)</strong> are the experts in charge of
developing and approving these protocols. ICANN controls the DNS
hierarchy and the allocation of IP addresses.</p>

::: endnote
<a href="#hint-groups" data-toggle="collapse" title="Learn more about the groups developing these protocols.">Learn
more about these organizations.</a>

::: {#hint-groups .collapse}
<p>The work of the IETF is done largely by email, and anyone with the
...
<p>The Internet Society (ISOC) is a worldwide nonprofit membership
...
policies supporting an open Internet.</p>
:::
:::
...
<p>If you think it's strange for one country to control a worldwide
...
dominated by the US government.</p>
...
<p>The issue of US control has become much more heated since 2013 when
...
eventually be resolved.</p>

::: endnote
<a href="#hint-US" data-toggle="collapse" title="How Did the US End Up In Charge?">How
Did the US End Up In Charge?</a>

::: {#hint-US .collapse}
<p>In 1968, the Advanced Research Projects Agency (ARPA) of the US
...
<p>The ARPANET was tiny, but it inspired the protocols that became
foundation of the Internet. And it belonged to the US military.</p>

<p>Once IP was invented in 1982, the ARPANET became just one network
...
IP-based networks were created.</p>

<a href="#hint-commerce" data-toggle="collapse" title="How did we move from research to commerce?">How
did we move from research to commerce?</a>

::: {#hint-commerce .collapse}
<p>During all this time, the assignment of IP addresses and host names
...
<p>In 2009, the Department of Commerce signed an agreement making ICANN
independent, although it still has a contract with the US that gives the
Department of Commerce a role in reviewing ICANN's operation.</p>
:::
:::
:::
