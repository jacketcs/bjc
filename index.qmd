...
Welcome to AP Computer Science Principles at Berkeley High School, taught by Ms. O'Keefe (and formerly co-developed with Ms. Chang). 
...
We want you to have fun and learn. This course will be run as a **"lab centric" class** built on project-based learning. You will learn by writing lots of code, not by listening to the teacher talk. There will sometimes be brief lectures near the beginning of class, but mostly you will be doing the problem solving on your own or with a partner, with support available from the teacher if requested. Working with other people is a key part of your educational experience.  *You will do most of your work paired with another person for support, and you should expect much of your learning will come from figuring out your mistakes/bugs, both on your own and together with your classmates.*
...
- Cell phones are never to be used in the computer lab and should be placed in the storage area as you enter the classroom. If I see your phone, I will take it and deduct participation points. If this happens repeatedly I will turn it into the OCI at the end of the period and you will have to retrieve it from there. 
- Handle computer equipment with care.

### Exiting the Lab

- Leave the room as clean or cleaner than when you entered it.
- Save all work (Snap does not autosave!) and log off of the computer.
...
50% Participation and Habits of Work
: This will be measured by sustained effort and focus during class, completing checkpoints/response forms on time, and meeting behavior expectations (staying on task, not causing distractions, putting your phone up).
...
5% Final Assessment
: A final project and assessment given at the end of the semester. 
