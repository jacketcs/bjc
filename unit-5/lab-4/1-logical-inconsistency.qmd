...
::: todo
<p>PG: Language inconsistency! Edit to clean up typos. I /really/ like
the ideas here but the feedback has not been good.</p>

<p>BH: But change the "at least four" problem to make it clear that
you're only allowed to ask one question.</p>

<p>MF: I want review this page and cut down on the switching back and
forth among colored boxes.</p>
:::
...
<p>Also, this lab overdoes decidability and solvability which has been
...
want to teach. --MF, 9/1/19</p>
:::

::: learn
<p><strong>In this lab,</strong> you will learn that some problems can't
be solved at all.</p>

<p><strong>On this page,</strong> you will solve logic puzzles by
...
<p>You are visiting the island and meet two of its people, Diego and
Zoey. Diego says, "Zoey and I are from the same family."</p>
...
A <strong>proof by contradiction</strong> is a two-step proof that a
...
::: vocabBig
<p>An <strong>undecidable</strong> statement might be true or might be
false; we don't know which.</p>

<p>A <strong>self-contradictory</strong> statement can be neither true
nor false.</p>
:::

<ul>

<li><strong>Provably True</strong>: For example in this problem, "Zoey
is a Truth-teller."</li>

<li><strong>Provably False</strong>: For example, "Zoey is a
False-teller."</li>

<li><strong>Undecidable</strong>: For example, "Diego is a
Truth-teller."</li>

<li><strong>Self-Contradictory</strong>: Such as "This statement is
false."</li>
