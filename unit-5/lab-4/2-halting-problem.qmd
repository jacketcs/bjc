...
---
        ...
        ##Assuming That a <code>Halts?</code> Function Exists
        ###<strong>Making the Assumption</strong>
        <p>
        ...
        ###<strong>Reviewing the Plan for the Proof</strong>
		...
		###<strong>Constructing a Program For Which <code>Halts?</code> Won't Work</strong>
		<p>
        ...
        ###<strong>Using Self-Reference to Lead to Contradiction</strong>
        <p>
...
<div class="todo">I took out class="indent" on this picture so that it'd fit in the window.  If you don't like that, figure out how to shrink the picture without fuzzing it up. -bh<br />OK, leaving this comment here to remind me for another day. --MF, 2/1/18</div>
        ...
        ###<strong>Understanding the Contradiction</strong>
        <p>
        ...
        <div class="endnote">
            ###<strong>Who first proved the Halting Theorem?</strong>
