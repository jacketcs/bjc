...
<img src="/img/5-algorithms/three-fn.png" title="three(x): report (3)" alt="three(x): report (3)" class="ms-4"/></p>

<p>This one <em>never</em> halts for any input:<br />
<img src="/img/5-algorithms/loop-fn.png" title="loop(x): forever (wait 1 secs)" alt="loop(x): forever (wait 1 secs)" class="ms-4" width="158"/></p>

<p>And this one halts <em>sometimes</em>---for any input except
87:<br />
<img src="/img/5-algorithms/weird-fn.png" title="weird(x): if (x = 87) (forever (wait 1 secs)) else (report (3))" alt="weird(x): if (x = 87) (forever (wait 1 secs)) else (report (3))" class="ms-4" width="158"/></p>
...
<img src="/img/5-algorithms/tester-halting.png" title="tester(reporter){if(halts?(reporter)(reporter){forever{}}else{report(true)}}" alt="tester(reporter){if(halts?(reporter)(reporter){forever{}}else{report(true)}}" class="ms-4"/></p>
