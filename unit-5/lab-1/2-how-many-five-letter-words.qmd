...
milliseconds).<br />
<img src="/img/5-algorithms/computation-time-reporting.png" title="computation time of (numbers from (1) to (1000)) reporting 27" alt="computation time of (numbers from (1) to (1000)) reporting 27" class="ms-4"/></p>
