...
<p><img src="/img/blocks/broadcast.png" title="broadcast" alt="broadcast" class="ms-4"/>
<img src="/img/blocks/when-i-receive.png" title="when I receive" alt="when I receive" class="ms-4"/></p>
...
<img src="/img/blocks/when-i-receive-any-message.png" title="when I receive (any message) (data)" alt="when I receive (any message) (data)" class="ms-4"/></p>
...
<img src="/img/5-algorithms/position-ranking.png" title="Tic-tac-toe grid showing happy faces in the corners and center and sad faces on the four edges" alt="Tic-tac-toe grid showing happy faces in the corners and center and sad faces on the four edges" class="ms-4 noshadow"/></p>
