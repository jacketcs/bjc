...
<html lang="en">
    ...
    <body>
        <h2>Creating a Computer Playersubtitle: "Unit , Lab , Page"
order:
---
        <div class="todo">
            ...
            <p>Students are already familiar with broadcast from 1.2.2. --MF, 6/26/20</p>
        </div>
        ...
        <h2>Have the Computer Move Randomly</h2>
        ...
        <div class="endnote">Recall that clones are temporary copies of a sprite. You learned about them in <a href="/cur/programming/3-lists/1-abstraction/5-building-tic-tac-toe.html?topic=nyc_bjc%2F2-conditionals-abstraction.topic&course=bjc4nyc.html&novideo&noassignment#clones" title="Unit 3 Lab 1 Page 5: Building a Tic-Tac-Toe Board">Unit 3 Lab 1 Page 5: Building a Tic-Tac-Toe Board</a>.</div>

        <p>
            <img class="indent" src="/img/blocks/broadcast.png" alt="broadcast" title="broadcast" />
            <img class="indent" src="/img/blocks/when-i-receive.png" alt="when I receive" title="when I receive" />
            <img class="indent" src="/img/blocks/message.png" alt="message" title="message" />
        </p>
		...
		<div class="forYouToDo" id="first">
			<ol>
                ...
                <li>
                    ...
                    <img class="indent" src="/img/5-algorithms/when-receive.png" alt="when I receive (any message) : if (message) = (square number) [nothing in script slot yet]" title="when I receive (any message) : if (message) = (square number) [nothing in script slot yet]" />
                </li>
                <li>
                    Create an abstraction to contain everything inside the <code>if</code> statement from the <code>when I am (clicked)</code> script and use it in both scripts.
                    <img class="indent" src="/img/5-algorithms/when-clicked.png" alt="when I am (clicked) {
    if ((costume #) = 1) {
        move in this square
    }
    ...
    if ((costume #) = 1) {
        move in this square
                    ...
                    <img class="indent" src="/img/5-algorithms/when-receive-move.png" alt="when I am (clicked) {
    ...
    if ((message) = (square number)) {
        move in this square
                ...
                <li>
                    <div class="sidenoteBig">
                        <a href="#hint-how-vacant" data-bs-toggle="collapse" title="How do I know which squares are vacant?">How do I know which squares are vacant?</a>
                        <div id="hint-how-vacant" class="collapse"><p>Look in <var>board</var>.</p></div>
                    </div>
                    <div class="todo">Overly scaffolded. --MF, 6/26/20</div>
                    In the <code>move in this square</code> block, after your code for Player X's turn, randomly pick a vacant square and use <code>broadcast</code> with that square number as the message. (The computer will move in the corresponding square, if your <code>when I receive</code> script is working.)
                </li>
				<li>Take turns with your partner playing Tic-Tac-Toe against the computer. Fix any bugs you find.</li>
			</ol>
		</div>

		<h2>Give the Computer a Simple Strategy</h2>
		...
		<p>Instead of having the computer move at random, you will start to give the computer some strategy. Unlike people, all squares on the tic-tac-toe board are <em>not</em> created equal. Playing in the center (position 5) or on a corner (positions 1, 3, 7, or 9) is better than playing on an edge (positions 2, 4, 6, or 8).<br />
            <img class="indent noshadow" src="/img/5-algorithms/position-ranking.png" alt="Tic-tac-toe grid showing happy faces in the corners and center and sad faces on the four edges" title="Tic-tac-toe grid showing happy faces in the corners and center and sad faces on the four edges" />
        </p>
        ...
        <div class="forYouToDo">
            <ol start="6">
                ...
                <li>
                    Create a <img class="inline" src="/img/5-algorithms/best-empty-square.png" alt="best empty square" title="best empty square" /> block that reports the best position on the board that is not yet filled. Use it as input to your <code>broadcast</code> instruction in place of <code>random</code>.
                    <div class="endnote">
                        <a href="#hint-empty" data-bs-toggle="collapse" title="Click for a hint about best empty square.">Click for a hint about <code>best empty square</code>.</a>
                        <div id="hint-empty" class="collapse"><img class="indent" src="/img/5-algorithms/empties.png" alt="list (5, 1, 3, 7, 9, 2, 4, 6, 8)" title="list (5, 1, 3, 7, 9, 2, 4, 6, 8)"></div>
                    </div>
                </li>
