...
::: endnote
<p>`Record` and `column` are <em>selectors</em>
...
<p>You may need to use `map`, `keep`, or
...
::: todo
<p>I need to redo these images and `code` statements with
...
::: endnote
```{=html}
<!--This gives away the answer. <p><a href="#hint-rowwithmax" data-bs-toggle="collapse" title="See the row with maximum in column () of table () block in action.">See `row with maximum in column () of table ()` in action.</a></p>
