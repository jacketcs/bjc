...
<p><a href="#hint-map" data-bs-toggle="collapse" title="Try to figure out how to report just one column, but click if you really need a hint.">Try
...
<p><a href="#hint-questions" data-bs-toggle="collapse" title="Click for example questions to ask about a single column.">Click
...
```
<p><a href="#hint-build" data-bs-toggle="collapse" title="Click for a hint about how to build row with maximum in column () of table ().">Click
