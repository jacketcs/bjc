...
::: learn
<p><strong>On this page</strong>, you will learn how data visualization
can help people understand data.</p>
:::

<p>Large data sets can be overwhelming to analyze, but software tools
...
<a href="#hint-axes" data-toggle="collapse" title="Reveal a hint about the axes.">Reveal
...
<img src="/img/icons/talk-with-your-partner-mini.png" title="Talk with Your Partner" alt="Talk with Your Partner" class="imageRight"/>
<strong>Analyze</strong> the data. In the interactive graph above, click
...
<strong>Do some research</strong> online or in the library to help you
...
meaning of the cluster of orange data points in the lower right. What
...
<p>In ordinary speech, the words "data" and "information" are used
interchangeably. But in computing, these words have specific technical
meanings.</p>

::: vocabFullWidth
: <strong>Data</strong> vs. <strong>Information</strong>
...
<li><strong>Data</strong> are the values that computers receive from
various sources, including human activity, sensors, etc.</li>

<li><strong>Information</strong> is the humanly-useful patterns
...
<p>The data given in the graph above let us answer some questions but
...
do, because the data displayed doesn't show jobs.</p>
...
::: vocabFullWidth
<p>A <strong>correlation</strong> is a particular kind of information,
...
<p><strong>Insight</strong> is a meaningful conclusion drawn from
analyzing information.</p>
:::
...
<p>The data by themselves don't tell you what causes what. There may be
...
the exact nature of the relationship, such as causation.</p>

::: endnote
<p><a href="http://tylervigen.com/view_correlation?id=79804" title="An example of two things that are obviously correlated, but obviously neither caused the other." target="_blank">An
example of two things that are obviously correlated, but obviously
neither caused the other.</a> You can click "Discover a new correlation"
on that site to find other strange correlations.</p>
:::
...
<p>Often, a single source does not contain the data needed to draw a
...
you have what seems like a reliable insight about causation.</p>
...
<li><img src="/img/icons/write-out-thoughts-mini.png" title="Write Out Your Thoughts" alt="Write Out Your Thoughts" class="inline"/><strong>Summarize
your findings.</strong> Write a paragraph or two with your partner
