...
<a href="https://www.gapminder.org/tools/#$ui$chart$showForecastOverlay:false&pauseBeforeForecast:false;;&model$markers$bubble$encoding$y$data$concept=children_per_woman_total_fertility&source=fasttrack&space@=geo&=time;;&scale$domain:null&zoomed:null&type:null;;&x$data$concept=lex&space@=geo&=time;;&scale$domain:null&zoomed:null&type:null;;&frame$speed:100;;;;;&chart-type=bubbles&url=v2" target="_blank" title="Fertility rate vs Life expectancy graph on Google">view
it on google.com</a>.
::::
...
<iframe title="Fertility v. Life Expectancy Data Visualizer" width="800" height="650" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" src="//www.gapminder.org/tools/?embedded=true#$ui$chart$showForecastOverlay:false&pauseBeforeForecast:false;;&model$markers$bubble$encoding$y$data$concept=children_per_woman_total_fertility&source=fasttrack&space@=geo&=time;;&scale$domain:null&zoomed:null&type:null;;&x$data$concept=lex&space@=geo&=time;;&scale$domain:null&zoomed:null&type:null;;&frame$speed:100;;;;;&chart-type=bubbles&url=v2" style="width: 100%; height: 500px; margin: 0 0 0 0; border: 1px solid grey;" allowfullscreen data-a11y-errors="true"></iframe>
...
**Do some research** online to help you
...
<li>Move the slider around between 1940 and 1950, and describe trends you see among certain countries. 
What is going on during this time?</li>

<li>Move the slider to 2023 (all the way to the right), and describe the
