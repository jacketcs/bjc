...
<p>Tables, diagrams, text, charts, graphs, and other visual tools help
extract, modify, and communicate information from data.</p>

<p><strong>On this page</strong>, you will create a visualizations to
help you analyze and communicate information from your dataset.</p>
:::
...
<p><strong>Classifying data</strong> means distributing data into groups
based on common characteristics.</p>
:::
...
::: endnote
<p>The <code>by intervals of</code> input to the <code>group
table</code> block should be left empty when, as in this example, the
field on which you're grouping is text rather than numbers. Later on
this page, you'll see how to use intervals in graphing.</p>
:::
...
Determine one question you can answer by <strong>grouping</strong> your
data, and build code to answer it.

::: endnote
<a href="#hint-grouping" data-toggle="collapse" title="Click for example questions for which grouping is helpful.">Click
...
inside one of the lists in column C, so you'd need two <code>keep</code>
functions.)</li>

</ul>

<p><code>Pipe</code> may be useful for questions that require looking
inside the inner lists of the grouped data (in column C).</p>
:::
:::
...
The <code>bar chart</code> function works like the <code>group</code>
...
::: endnote
<p>The number in column A is the <em>largest</em> value included in each
...
::: vocab
<p>The <strong>mode</strong> of a data set is the value that appears
most often in it.</p>
:::
