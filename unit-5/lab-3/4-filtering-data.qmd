...
::: {#hint-pipe .collapse}
<p>You can use the `pipe` function from the "Bar Charts"
...
`average` to get the average of those Subaru MPG values.</p>
...
<p>You built `average` on <a href="/unit-2/lab-4/3-other-math-reporters.html" title="Unit 2 Lab 4 Page 3: Other Mathematical Reporters">Unit 2 Lab 4 Page 3: Other Mathematical Reporters</a>.</p>-->
```
:::
:::
...
::: endnote
<p>`Find first` is equivalent to `item (1) of
