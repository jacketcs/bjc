...
a `simulate disease` function <strong>for you to
...
<li>a `touching infected person?` predicate <strong>for you
...
<li>a `when I start as a clone` script <strong>for you to
