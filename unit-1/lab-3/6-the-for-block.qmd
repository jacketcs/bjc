...
<li>Change the inputs to <code>turn</code> and <code>move</code> to get as close as you can get to a smooth spiral:<br /> <img src="/img/prog/spiral.png" title="spiral" alt="spiral" class="ms-4"/></li>
