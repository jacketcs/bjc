...
<p><strong>On this page,</strong> you will explore the basics of drawing a shape in Snap<em>!</em> by using the `repeat` block to loop through the same code multiple times.</p>
:::
