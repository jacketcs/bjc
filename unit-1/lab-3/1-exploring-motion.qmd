...
<li>Use <img src="/img/blocks/set-pen-size-to-blank.png" title="set pen size to ()" alt="set pen size to ()" class="inline"/> to set the pen size to something like 4 or 10 or 50. Then click your <code>repeat</code>, <code>move</code>, <code>turn</code> script again.</li>
