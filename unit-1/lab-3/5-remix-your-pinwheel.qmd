...
This is an example of <strong>abstraction by generalization</strong>: looking at chunks of code that are <em>almost the same</em> and writing a single block by <em>using an input</em> to distinguish among the different cases.
:::
...
(@) {{< checkpoint text='Fill out this Google Form' id='1FAIpQLSdpOK9EOWOW0yux1TeXyfHbaGPQR9Buwne5P-mKAmv1StGxnA' >}}
