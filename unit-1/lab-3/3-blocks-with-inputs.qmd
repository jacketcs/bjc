...
<p>On the previous page you used blocks `asterisk` and `pinwheel` that we wrote for you, each with an input for the number of spokes. Now you're going to learn how to create your own blocks with inputs.</p>
...
<strong>Create a new block, type the block name and the label for your input, and click OK.</strong> For this project, type `pinwheel, branches:`.
...
<strong>Click the + (plus sign) after "`branches:`", type the name of the input, and click OK</strong> to add the input slot. For this project, click the + after "`branches:`" and type <var>number of branches</var> as the name of your input.
...
::: forYouToDo
5. Create a script that draws two pinwheels on the stage, with different numbers of spokes.
:::
