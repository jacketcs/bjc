...
::: learn
<strong>In this project,</strong> you are going to write code to draw the geometric design shown below, explore its variations and use it draw more complex designs.<br /> <img src="/img/1-introduction/Daisy_img/Daisy.png" title="Daisy" alt="Daisy" class="ms-4 noshadow" width="242"/>
:::
