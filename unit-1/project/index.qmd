...
You'll be able to see this when the time comes :)
...
In addition, you'll have a writeup where you will explain why, where, and how you used blocks in your project.
...
::: forYouToDo
When you have finished your app, fill in the writeup on the **given template in Google Classroom**. This kind of write-up is part of what you will need to do for the AP Create Task.

<details>
<summary>The template has the following questions for you to answer:</summary>
...
1. 1. Explain how the user interacts with your e-card
