...
(@) Uses a `repeat until` or `for` loop.
...
(@) Includes one additional feature. You can choose:
    ...
    - Uses the `random` block OR
    - Uses the pen tool to draw something on the screen
...
::: forYouToDo
When you have finished your project, {{< checkpoint text='turn it in on this form' id='1FAIpQLSfY8QW7JeM2os8C2MHVg8DjanNHPHdfP2j0_ngBZgHdo8VkfA' >}}
