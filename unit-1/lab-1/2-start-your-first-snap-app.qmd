...
Attach this to the bottom of your Alonzo script:<br /> <img src="/img/1-introduction/forever-jump.png" title="forever {go to (random position)}" alt="forever {go to (random position)}" class="ms-4"/>
...
{{< checkpoint text="Fill out this Google Form" id="1FAIpQLSclBVnTClsKqL3h5aVil7EjVhRw5OkNGfMjaFlEgMdo-mIv7Q" >}}

<!-- id is from the url of the shared google form i.e.
https://docs.google.com/forms/d/e/1FAIpQLSclBVnTClsKqL3h5aVil7EjVhRw5OkNGfMjaFlEgMdo-mIv7Q/viewform?embedded=true
 -->
