...
Attach this to the bottom of your Alonzo script:<br /> <img src="/img/1-introduction/forever-jump.png" title="forever {go to (random position)}" alt="forever {go to (random position)}" class="indent"/>
