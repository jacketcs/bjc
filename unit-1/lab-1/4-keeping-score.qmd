...
- One is a <em><strong>sprite</strong></em>, which is like an actor on the stage who knows how to do many different things, such as walk around the stage and speak the lines of the play.
- The other two are <em><strong>costumes</strong></em>, picture that can be "worn" by a sprite.
:::
...
9. {{< checkpoint text="Fill out this Google Form" id="1FAIpQLSe2lbquJaD3SMPHpZYu1_oswR5IfxUgbZhZKlg7gvyGT3Gc4w" >}}
