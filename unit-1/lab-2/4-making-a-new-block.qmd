...
::: endnote
<p>Because you chose the reporter shape, the block editor opens with a <img src="/img/blocks/report.png" title="report" alt="report" class="inline py-0"/> block already attached to the hat block. Whatever input you give to <code>report</code> will become the value reported by your new block.</p>
:::
