...
<li>To <strong>concatenate</strong> strings means to make a bigger string by connecting two or more smaller strings. In Snap<em>!</em>, the <img src="/img/blocks/join()().png" title="join () ()" alt="join () ()" class="inline py-0"/> block lets you concatenate strings.</li>
...
Which <em><strong>two</strong></em> of the following sentences could be reported by <code>gossip</code>?<br /> <img src="/img/1-introduction/gossip-definition.png" title="gossip: (report (join (who) ( ) (does what) ( ) (who)))" alt="gossip: (report (join (who) ( ) (does what) ( ) (who)))" class="ms-4"/>
...
<li>You can change the size of your sprite using <img src="/img/blocks/set-size-empty.png" title="set size to ( ) %" alt="set size to ( ) %" class="inline py-0"/>.</li>

<li>You can change the position of your sprite using <img src="/img/blocks/go-to-x-y.png" title="go to x: () y: ()" alt="go to x: () y: ()" class="inline py-0"/>.</li>

<li>You can change the direction your sprite is facing:<br /> <img src="/img/1-introduction/point-in-direction-menu-showing.png" title="point in direction (270) with menu open showing right left, up, down, random" alt="point in direction (270) with menu open showing right left, up, down, random" class="ms-4"/><br></li>
...
<img class="ms-4" src="/img/1-introduction/U1ImageVideoAddendum_img/U1L5-Rotate1.png"  height="100" alt="can rotate button" title="can rotate button" />
...
<img class="ms-4" src="/img/1-introduction/U1ImageVideoAddendum_img/U1L5-Rotate2.png"  height="100" alt="only face left/right button" title="only face left/right button"/>
...
<img class="ms-4" src="/img/1-introduction/U1ImageVideoAddendum_img/U1L5-Rotate3.png"  height="100" alt="don't rotate button" title="don't rotate button"/>
