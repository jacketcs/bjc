...
Make sure you have the <strong>Follower</strong> sprite selected. Write a script for <strong>Follower</strong> so that once the green flag is clicked, it will point toward <strong>Leader</strong> `forever`.<br /> <img src="/img/blocks/point-towards.png" title="point towards []" alt="point towards []" class="ms-4"/>
