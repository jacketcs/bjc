...
<img src="/img/1-introduction/topic1-kaleidoscope.gif" alt="Kaleidoscope Activity" class="indent"/></p>
:::
...
<img src="/img/2-complexity/draggable-check-box.png" title="draggable box checked" alt="draggable box checked" class="imageRight"/>
...
::: endnote
<p><a href="#hint-mousedown" data-toggle="collapse" title="Need a reminder about making the first sprite follow the mouse, detecting an event, or drawing only when the mouse is down?">Need
a reminder?</a></p>
...
<p><a href="#hint-second-sprite" data-toggle="collapse" title="Need a hint about making the second sprite mirror the first one?">Need
...
<a href="#hint-second-sprite-second-hint" data-toggle="collapse" title="Need another hint aboout the second sprite that mirrors the first?">Need
another hint?</a>
