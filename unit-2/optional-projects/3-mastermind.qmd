...
::: todo
<p>PG: This has the same potential as TTT to be a multistage (year long)
project. I'd elevate it, provided that a good /learning/ goal is
clarified.</p>

<p>BH: What a great project! We should finish it with the computer
guessing.</p>

<p>MF: I want to revise this page to reduce the text wall and to make
the rest of the page look more like the rest of our content.</p>
:::

::: learn
<strong>In this project,</strong> you will begin to build the game
Mastermind™. In this game, one player selects a sequence of four secret
colors, and the other player tries to guess it.<br />
<img src="/img/1-introduction/mm-snapshot.png" title="Snapshot of game" alt="Snapshot of game" class="indent" width="250"/>
:::
...
<strong>Feedback to the guesser</strong> is two numbers (as shown in
...
::: narrower
<h4><strong>Mastermind Rules</strong></h4>

<ul>

<li>

<strong>Each player should write down a sequence of four colors</strong>
without letting your partner see it.

<ul>

<li>For convenience, you can use the first letter of each color name to
represent that color: <strong><u>r</u></strong>ed,
<strong><u>o</u></strong>range, <strong><u>y</u></strong>ellow,
<strong><u>g</u></strong>reen, <strong><u>b</u></strong>lue,
<strong><u>v</u></strong>iolet. (For now, don't use the same color more
...
<strong>Take turns guessing your partner's colors</strong>. When your
partner makes a guess, give two numbers as feedback as described above.

<ul>

<li>For example, if your secret colors are <strong>royg</strong> and
your partner guesses<strong> goby</strong> you reply "one and two,"
...
<strong>Use the information you have from earlier guesses</strong> to
make the best guesses you can.

<ul>

<li>For example, after <strong>goby</strong> in the example above, you
...
guess would be <strong>grob</strong> because that has green in the same
...
<strong>goby</strong> above).<br />
<img src="/img/2-complexity/mm1.png" title="first guess interaction" alt="first guess interaction" class="indent noshadow"/></li>

<li>Display that guess on the screen.<br />
<img src="/img/2-complexity/mm2.png" title="four colors displayed" alt="four colors displayed" class="indent noshadow"/></li>

<li>Ask the other player for feedback, as two numbers.<br />
<img src="/img/2-complexity/mm3.png" title="asking interaction" alt="asking interaction" class="indent noshadow"/>
<img src="/img/2-complexity/mm4.png" title="four colors 2 points" alt="four colors 2 points" class="indent noshadow"/></li>
...
<img src="/img/1-introduction/tell-alonzo.png" title="tell (Alonzo) to (say ...)" alt="tell (Alonzo) to (say ...)" class="indent"/>
<img src="/img/1-introduction/tell-correct.png" title="tell (correct position) to (show value (# correct))" alt="tell (correct position) to (show value (# correct))" class="indent"/>
:::
