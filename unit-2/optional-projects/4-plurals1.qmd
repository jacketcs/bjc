...
<img src="/img/2-complexity/plural-day-with-result.png" title="plural (day) reporting (days)" alt="plural (day) reporting (days)" class="indent"/>
...
the word "box":<br />
<img src="/img/2-complexity/plural-box-with-(wrong)-result.png" title="suffix s box (with wrong result)" alt="suffix s box (with wrong result)" class="indent"/><br />
...
<img src="/img/2-complexity/map-plural-over-list-of-nouns.png" title="map (plural ( )) over &apos;a list block containing: day, boss, moth, box, butterfly, brush...&apos; (the end of the image is cut off)" alt="map (plural ( )) over &apos;a list block containing: day, boss, moth, box, butterfly, brush...&apos; (the end of the image is cut off)" class="indent"/><br />
...
<img src="/img/2-complexity/keep-items-such-that-(last-letter-of-(input)-equals-h)-from-test-list.png" title="keep items (last letter of &apos;empty input slot&apos; = h) from &apos;a list block containing: day, boss, moth, box, butterfly, brush...&apos; (the end of the image is cut off)" alt="keep items (last letter of &apos;empty input slot&apos; = h) from &apos;a list block containing: day, boss, moth, box, butterfly, brush...&apos; (the end of the image is cut off)" class="indent"/><br />
and<br />
<img src="/img/2-complexity/keep-items-such-that-(last-letter-of-(input)-equals-y)-from-test-list.png" title="keep items (last letter of &apos;empty input slot&apos; = y) from &apos;a list block containing: day, boss, moth, box, butterfly, brush...&apos; (the end of the image is cut off)" alt="keep items (last letter of &apos;empty input slot&apos; = y) from &apos;a list block containing: day, boss, moth, box, butterfly, brush...&apos; (the end of the image is cut off)" class="indent"/><br />
...
example:<br />
<img src="/img/2-complexity/conjugate-verb-(spanish)-for-nosotros-comer.png" title="conjugate verb (Spanish), pronoun: (nosotros) verb: (comer) reporting &apos;comemos&apos;" alt="conjugate verb (Spanish), pronoun: (nosotros) verb: (comer) reporting &apos;comemos&apos;" class="indent"/>
<img src="/img/2-complexity/conjugate-verb-(spanish)-for-yo-tocar.png" title="conjugate verb (Spanish), pronoun: (yo) verb: (tocar) reporting &apos;toco&apos;" alt="conjugate verb (Spanish), pronoun: (yo) verb: (tocar) reporting &apos;toco&apos;" class="indent"/></li>
