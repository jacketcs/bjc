...
<p>If you want to add more script variables, use the right-pointing triangle. (The left triangle will remove them.)<br /> <img title="clicking triangles to add and remove script variables" alt="clicking triangles to add and remove script variables" class="ms-4" data-gifffer="/img/2-complexity/script-variables-adding.gif" height="70"/></p>
:::
