...
(@) Use <img src="/img/blocks/set-empty.png" title="set () to ()" alt="set () to ()" class="inline py-0"/> to set the initial value of <var>secret number</var> to a random number from 1 to 10 using the <img src="img/blocks/pick-random-1-to-10.png"> block. The `set` menu lets you select which variable to set. 
