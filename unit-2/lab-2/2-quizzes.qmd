...
<li><img src="/img/icons/take-turns-speaking-mini.gif" title="Take turns speaking" alt="Take turns speaking" class="inline"/>Read the following section.<b> (Don't build these in Snap<em>!</em></b>. You'll build your own quiz later on the page.)</li>
