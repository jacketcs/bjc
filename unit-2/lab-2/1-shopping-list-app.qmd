...
The shopping list can be improved so much more! Do the following to improve the user's experience.

<ol type="A">
<li>Add Item: Check for duplicates before adding</li>
<li>Clear list: Ask if they are sure before clearing - use menu for response</li>
<li>Delete item: Allow user to delete by number or name</li>
<li>Delete item: Check to see if multiple list items contain requested item, display all matches and ask user to choose (can also choose none)</li>
<li>Writing the list: add a new sprite that will write the list to the screen instead of using the native list display</li>
</ol>
