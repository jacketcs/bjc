...
<li>Notice that a global variable called <var>shopping list</var> has already been created for you.</li>

<li>

The <var>shopping list</var> variable has already been set to be a list. If it gets set to a value and not a list (the display will look different if this happens), you will need to reset it to be an <em>empty</em> list (a list with nothing in it). You will need a <img src="/img/blocks/list-full-size.png" title="list ()" alt="list ()" class="inline"/> block.
