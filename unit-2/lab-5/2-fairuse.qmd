...
::: learn
<p><strong>On this page,</strong> you will learn about times when it is
ok to copy part of someone else's work.</p>
:::
...
<strong>You can quote a <em>short</em> excerpt from someone else's work
for purposes of reviewing the original.</strong>

::: endnote
<a href="#hint-short" data-toggle="collapse" title="What counts as a 'short' excerpt'?">What
counts as "short"?</a>
...
<li><strong>You can copy newspaper articles for use in teaching a class
<em>if</em></strong> the event reported in the article was not
...
<strong>You can produce a <em>parody</em> of a copyrighted
work.</strong>
...
<img src="/img/5-algorithms/parodius.gif" alt="parody cartoon" class="indent"/><br />
<small class="indent">Copyright 2016 by
...
<li><strong>Titles are not copyrightable at all.</strong> You can write
a song and call it "She Loves You," as long as the song itself is
different from the Beatles' version.</li>

<li>You can, of course, copy anything <strong>if you get
permission</strong> from the copyright holder.</li>

<li>

<strong>Authors who want their works to be generally available</strong>
...
<li><strong>Creative Commons</strong> is a specific family of copyright
...
<li><strong>Free software</strong> means software that anyone can copy,
...
<a href="#why-free" data-toggle="collapse" title="Doesn't the &ldquo;provided that&rdquo; make it unfree?">Doesn't
...
<li><strong>Open source</strong> software is a more general term that
...
::: endnote
<img src="/img/icons/read-more.png" title="Read More" alt="Read More" class="inline"/>
<a href="#why-open" data-toggle="collapse" title="What's the point of making it available if people aren't allowed to use it?">What's
...
<li><strong>Open access</strong> scholarly research reports are
...
<p>Why would an author give away the right to make copies of a work?
