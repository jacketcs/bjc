...
::: learn
<p><strong>On this page,</strong> you will match Boolean expressions
with the pictures they help create.</p>
:::

::: forYouToDo
<ol>

<li><img src="/img/icons/talk-with-your-partner-mini.png" title="Talk with Your Partner" alt="Talk with Your Partner"/>
...
<li><img src="/img/2-complexity/x-lt--100-script.png" title="x position &lt; -100" alt="x position &lt; -100"/></li>

<li><img src="/img/2-complexity/x-lt-100-script.png" title="x position &lt; 100" alt="x position &lt; 100"/></li>

<li><img src="/img/2-complexity/x+y-lt-100-script.png" title="x position + y position &lt; 100" alt="x position + y position &lt; 100"/></li>

<li>-100" title="y position \> -100" /\></li>

<li><img src="/img/2-complexity/x+y-lt--100-script.png" title="y position &lt; (-100 - x position)" alt="y position &lt; (-100 - x position)"/></li>

<li><img src="/img/2-complexity/y-lt--100-script.png" title="y position &lt; -100" alt="y position &lt; -100"/></li>

<li>100" title="distance to apple \> 100" /\></li>

<li>-100" title="x position \> -100" /\></li>

<li>(100 - x position)" title="y position \> (100 - x position)"
/\></li>

<li>0" title="(x position \* y position) \> 0" /\></li>

<li>-100" title="(x position + y position) \> -100" /\></li>

<li><img src="/img/2-complexity/xy-lt-0-script.png" title="(x position * y position) &lt; 0" alt="(x position * y position) &lt; 0"/></li>

<li>((x position \^ 2) / 100)" title="y position \> ((x position \^ 2) /
100)" /\></li>

<li>135" title="direction to apple \> 135" /\></li>
...
<li>Compare answers with another pair and resolve any
disagreements.</li>

<li>On paper, sketch the pictures for the expressions you didn't match
with pictures in the previous problem (without using
Snap<em>!</em>).</li>

<li><a href="/prog/2-complexity/U2L3-Dots.xml" class="run"><img src="/img/icons/load-save.png" title="Click here to load this file. Then save it to your Snap! account." alt="Click here to load this file. Then save it to your Snap! account." class="inline"/></a></li>
