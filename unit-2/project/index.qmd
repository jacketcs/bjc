...
{{< video https://youtu.be/txQ-YFLbg1o >}}
...
3. Implement the block ![insert example responses into survey responses](/img/2-complexity/Survey/insert-example%20responses-into%20survey-responses.png) that puts ten or so example responses into the list.
