...
::: endnote
<p>You may wish to use the `warp` block to make your
animations render more quickly.<br />
<img src="/img/blocks/warp.png" title="warp block" alt="warp block" class="ms-4"/></p>
...
<img src="/img/3-lists/AnimationStudio_img/uncheckpointlist.png" title="uncheck point list" alt="uncheck point list" class="ms-4" height="80"/></p>
:::
