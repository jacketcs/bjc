...
<img src="img/2-complexity/maze-above.png" title="drawing of maze seen from above" alt="drawing of maze seen from above" class="indent"/>
<img src="img/2-complexity/maze-inside.jpg" title="photograph of maze of hedges with tall walls seen from the inside" alt="photograph of maze of hedges with tall walls seen from the inside" class="indent" width="240"/>
...
<img src="img/3-lists/robot-question-1-grid.png" title="5×5 grid of squares with an upward-facing sprite in the center square" alt="5×5 grid of squares with an upward-facing sprite in the center square" class="indent noshadow"/></li>
