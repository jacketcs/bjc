...
::: learn
<p><strong>In this lab</strong>, you will continue your
...
detect wins and ties.</p>

<p><strong>On this page</strong>, you'll prepare by allowing the program
...
::: sidenote
<p>You learned about <strong>global variables</strong> on
<a href="/unit-2/lab-1/4-keeping-score.html" title="Unit 2 Lab 1 Page 4: Keeping Score with Global Variables">Unit
2 Lab 1 Page 4: Keeping Score with Global Variables</a>.</p>
:::
...
<li>Open your <strong>U3L1-TicTacToe</strong> project, and save it as
<strong>U3L3-TicTacToe</strong> so you'll still have your old version
...
<p>Each sprite needs to know its own position on the board so that you
can use the <code>item of</code> block to replace that position with an
X or an O. So, you'll create a <em>sprite variable</em>,
<img src="/img/3-lists/position-number.png" title="position number" alt="position number" class="inline nopadtb"/>,
and each clone will have its <em>own version</em> of this variable.</p>

::: vocabFullWidth
: <strong>Sprite Variable</strong>

<p>A <strong>sprite variable</strong> is like a global variable in that
it <em>doesn't</em> belong to a particular <em>script</em>, but it does
belong to a particular <em>sprite.</em></p>
:::
...
::: sidenote
<p>You learned about <strong>initializing variables</strong> on
...
<li>Click
<img src="/img/1-introduction/make-a-variable.png" title="make a variable button" alt="make a variable button" class="inline nopadtb noshadow"/>
...
<img src="/img/3-lists/square-number-var.png" title="variable name dialog box with &apos;for this sprite only&apos; selected" alt="variable name dialog box with &apos;for this sprite only&apos; selected" class="indent"/><br />
:::
...
::: endnote
<a href="#hint-1" data-toggle="collapse" class="collapsed" title="Hint">Click
...
<p>To program a way to detect a win, you need to determine what counts
...
<img src="/img/3-lists/winning-combo-357.png" title="diagonal win bottom left to top right" alt="diagonal win bottom left to top right" class="indent noshadow"/><br /></p>
...
game stored by <var>board</var>.</p>
...
<img src="/img/3-lists/winning-triples.png" title="winning triples partial block definition showing a list with at least two lists inside it: {1,2,3} and {2,5,8}" alt="winning triples partial block definition showing a list with at least two lists inside it: {1,2,3} and {2,5,8}" class="indent"/></li>
