...
<li>When a square is clicked, use the <var>replace () of (list) with ()</var> block (found towards the bottom of the red palette) to update that square's entry in the
