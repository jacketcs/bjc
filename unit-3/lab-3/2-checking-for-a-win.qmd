Unit 3 Lab 3: Tic-Tac-Toe, Page 2</title>
    </head> 
    
    <body>
       <h2>Detecting A Winsubtitle: "Unit , Lab , Page"
order:
---
        <div class="todo">
        ...
        <div class="endnote">
            <p>You learned about <code>map</code> in <a href="/cur/programming/3-lists/2-contact-list/5-mapping-over-list.html?topic=nyc_bjc%2F3-lists.topic&course=bjc4nyc.html&novideo&noassignment" title="Unit 3 Lab 2 Page 5: Transforming Every List Item">Unit 3 Lab 2 Page 5: Transforming Every List Item</a>.</p>
            <p>
                ...
                <img class="indent" src="/img/3-lists/map-example-2.png" alt="map (join( )(s)) over (list {cat, dog, bird}) reporting {cats, dogs, birds}" title="map (join( )(s)) over (list {cat, dog, bird}) reporting {cats, dogs, birds}" />
            </p>
        ...
        <div class="forYouToDo">
            ...
            <img class="indent noshadow" src="/img/3-lists/ttt-board-var.png" alt="picture of: watcher of board variable showing {O, O, X, 4, X, 6, X, 8, 9}; and Tic Tac Toe game with X, X, O in top row; empty, X, empty in middle row; and X, empty, empty in bottom row" title="picture of: watcher of board variable showing {O, O, X, 4, X, 6, X, 8, 9}; and Tic Tac Toe game with X, X, O in top row; empty, X, empty in middle row; and X, empty, empty in bottom row" />
                               <img class="indent" src="/img/3-lists/map-item-board-reporting.png" alt="map (item ( ) of (board)) over (list{1, 2, 3}) reporting {O, O, X}" title="map (item ( ) of (board)) over (list{1, 2, 3}) reporting {O, O, X}"><br />
							</p>
                        </div>
                    </div>
                </li>
                ...
                <li>
                	Use this idea to make a <img src="/img/3-lists/status-of-triple.png" alt="status of triple ( )" title="status of triple ( )"> block that takes one possible winning triple (a triple like <img src="/img/3-lists/{1,2,3}.png" alt="list{1, 2, 3}" title="list{1, 2, 3}">) as input and reports a list of what is in those three positions (X, O, or a number).  Then use it to write an expression in the scripting area whose value will be <code>True</code> if X won the game <em>in the triple <img src="/img/3-lists/{1,2,3}.png" alt="list{1, 2, 3}" title="list{1, 2, 3}">,</em> or <code>False</code> otherwise.
                    <div class="endnote">You learned how to specify the list input type (<img class="inline" src="/img/3-lists/list_input_slot.png" alt="list input type: rectangle with two smaller orange rectangles inside" title="list input type: rectangle with two smaller orange rectangles inside">) on <a href="/cur/programming/2-complexity/2-data-structures-art/2-quizzes.html?topic=nyc_bjc%2F2-conditionals-abstraction.topic&course=bjc4nyc.html&novideo&noassignment" title="Unit 2 Lab 2 Page 2: Planning a Quiz App">Unit 2 Lab 2 Page 2: Planning a Quiz App</a>.</div>
                </li>
                <li>
        ...
        <h2>Checking All the Ways to Win</h2>
	...
	<p>
        ...
        <div class="forYouToDo">
			<ol start="7">
	            ...
	            <div class="endnote">
                    <a href="#hint-status-all" data-bs-toggle="collapse" title="Click for a hint on how to use map.">Click for a hint on how to use <code>map</code>.</a>
                ...
                <div class="sidenoteBig">
                	<a href="#hint-won" data-bs-toggle="collapse" title="Click for a hint on building won?.">Click for a hint on building <code>won?</code>.</a>
					<div id="hint-won" class="collapse">
                        ...
                        <p>
                            <a href="#hint-won-contains" data-bs-toggle="collapse" title="Click for another hint.">Click for another hint.</a>
                            <div id="hint-won-contains" class="collapse"><img src="/img/3-lists/contains.png" alt="( ) contains ( )" title="( ) contains ( )" /></div>
                        </p>
                    </div>
                </div>
                <li>Now make a block <img src="/img/3-lists/wonQ.png" alt="won? ( )" title="won? ( )"> that takes the letter <strong>X</strong> or <strong>O</strong> as input, and reports <code>true</code> if and only if that player has won the game. </li>
                <img class="imageRight" src="/img/icons/save-mini.png" alt="Save Your Work" title="Save Your Work" />
