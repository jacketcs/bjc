...
<img src="/img/3-lists/map-example-2.png" title="map (join( )(s)) over (list {cat, dog, bird}) reporting {cats, dogs, birds}" alt="map (join( )(s)) over (list {cat, dog, bird}) reporting {cats, dogs, birds}" class="indent"/></p>
...
<img src="/img/3-lists/map-item-board.png" title="map (item ( ) of (board)) over (list{1, 2, 3})" alt="map (item ( ) of (board)) over (list{1, 2, 3})" class="indent"/><br />

::: endnote
<a href="#hint-map-item" data-toggle="collapse" title="How does map work here?">How
...
<li><img src="/img/icons/save-mini.png" title="Save Your Work" alt="Save Your Work" class="imageRight"/>
...
::: endnote
<a href="#hint-status-all" data-toggle="collapse" title="Click for a hint on how to use map.">Click
...
::: sidenoteBig
<a href="#hint-won" data-toggle="collapse" title="Click for a hint on building won?.">Click
...
<a href="#hint-won-contains" data-toggle="collapse" title="Click for another hint.">Click
for another hint.</a>
