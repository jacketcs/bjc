...
(@) Coding requirements:
    ...
    - Use at least two of these major programming techniques that we've learned this year:
         ...
         * High order functions with custom blocks inside the grey ring
         <p>
         *<b>Note that</b> to count, the use of each technique must be more than trivial, meaning the program would be impossible or must harder to code if the technique were not used. 
