...
<h4><strong>Difference Engine</strong></h4>
...
<h4><strong>The Analytical Engine</strong></h4>
...
<img src="/img/6-computers/punched-cards-analytical-engine.jpg" title="punched cards used to program the Analytic Engine" alt="punched cards used to program the Analytic Engine" class="indent" height="300px"/>
...
<img src="/img/6-computers/ada-lovelace.jpg" title="Ada, Countess Lovelace" alt="Ada, Countess Lovelace" class="indent" height="300px"/>
...
Consider the Snap<em>!</em> instruction <img src="/img/6-computers/set-c-to-a+b.png" title="set (c) to (a + b)" alt="set (c) to (a + b)" class="inline nopad"/>. In a lower-level language such as C or Java, the same idea would be written as:<br />
...
<img src="/img/6-computers/arduino.jpg" title="Arduino board" alt="Arduino board" class="imageRight"/>
...
<img src="/img/6-computers/arduino-shields.jpg" title="stack of Arduino shields" alt="stack of Arduino shields" class="indent" width="250px"/>
...
<img src="/img/6-computers/raspberry-pi.jpg" title="Raspberry Pi board" alt="Raspberry Pi board" class="indent" width="250px"/>
:::
